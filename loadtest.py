...
WEIGHT_BUG_VIEW = int(os.getenv('WEIGHT_BUG_VIEW') or '0')
WEIGHT_BUG_VIEW_AVG = int(os.getenv('WEIGHT_BUG_VIEW_AVG') or '0')
WEIGHT_BUG_VIEW_XL = int(os.getenv('WEIGHT_BUG_VIEW_XL') or '0')
WEIGHT_TREE_VIEW = int(os.getenv('WEIGHT_TREE_VIEW') or '0')
WEIGHT_QUICKSEARCH_LIMITED = int(os.getenv('WEIGHT_QUICKSEARCH_LIMITED') or '0')  # noqa
WEIGHT_QUICKSEARCH_UNLIMITED = int(os.getenv('WEIGHT_QUICKSEARCH_UNLIMITED') or '0')  # noqa
...
@scenario(WEIGHT_BUG_VIEW)
async def load_page_bug_view(session):
...
@scenario(WEIGHT_QUICKSEARCH_LIMITED)
...
@scenario(WEIGHT_QUICKSEARCH_UNLIMITED)
